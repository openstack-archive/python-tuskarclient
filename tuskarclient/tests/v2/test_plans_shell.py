...
class PlansShellTest(BasePlansShellTest):
    ...
    def test_plan_templates(
        ...
        mock_open.return_value.write.assert_any_call('value_foo')
        mock_open.return_value.write.assert_any_call('value_bar')
        self.assertEqual(mock_open.return_value.write.call_count, 2)
