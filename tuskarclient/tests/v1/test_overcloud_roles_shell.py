...
class RacksShellTest(tutils.TestCase):
    ...
    @mock.patch('tuskarclient.v1.overcloud_roles_shell.print_overcloud_role_detail')
    def test_overcloud_role_show(self, mock_print_detail, mock_find_resource):
        mock_find_resource.return_value = mock_overcloud()
        args = empty_args()
        args.id = '5'

        self.shell.do_overcloud_role_show(self.tuskar, args, outfile=self.outfile)
    ...
    def test_overcloud_role_list(self, mock_print_list):
        ...
        self.shell.do_overcloud_role_list(self.tuskar, args, outfile=self.outfile)
    ...
    @mock.patch('tuskarclient.common.utils.find_resource')
    @mock.patch('tuskarclient.v1.overcloud_roles_shell.print_overcloud_role_detail')
    def test_overcloud_role_create(self, mock_print_detail, mock_find_resource):
        mock_find_resource.return_value = mock_overcloud()
        args = empty_args()
        ...
        self.shell.do_overcloud_role_create(self.tuskar, args, outfile=self.outfile)
        self.tuskar.overcloud_roles.create.assert_called_with(
            name='my_overcloud',)
        mock_print_detail.assert_called_with(
            self.tuskar.overcloud_roles.create.return_value, outfile=self.outfile)

    @mock.patch('tuskarclient.common.utils.find_resource')
    @mock.patch('tuskarclient.v1.overcloud_roles_shell.print_overcloud_role_detail')
    def test_overcloud_role_update(self, mock_print_detail, mock_find_resource):
        mock_find_resource.return_value = mock_overcloud()
        args = empty_args()
        args.id = '5'
        args.name = 'My Overcloud Role'
        ...
        self.shell.do_overcloud_role_update(self.tuskar, args, outfile=self.outfile)
        self.tuskar.overcloud_roles.update.assert_called_with(
            '5',
            name='my_overcloud')
        mock_print_detail.assert_called_with(
            self.tuskar.overcloud_roles.update.return_value, outfile=self.outfile)
    ...
    def test_overcloud_role_delete(self, mock_find_resource):
        ...
        self.shell.do_overcloud_role_delete(self.tuskar, args, outfile=self.outfile)
