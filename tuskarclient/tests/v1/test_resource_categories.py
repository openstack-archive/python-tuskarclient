...
class ResourceCategoryManagerTest(tutils.TestCase):
    ...
    def test_get(self):
        ...
        self.rcm._get.assert_called_with('/v1/resource_categories/42')
    ...
    def test_get_404(self):
        ...
        self.rcm._get.assert_called_with(
            '/v1/resource_categories/fake_resource_category')
    ...
    def test_list(self):
        ...
        self.rcm._list.assert_called_with('/v1/resource_categories')
    ...
    def test_delete(self):
        ...
        self.rcm._delete.assert_called_with('/v1/resource_categories/42')
