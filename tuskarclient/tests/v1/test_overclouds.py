...
class OvercloudManagerTest(tutils.TestCase):
    ...
    def test_get(self):
        ...
        self.om._get.assert_called_with('/v1/overcloud/fake_overcloud')
    ...
    def test_list(self):
        ...
        self.om._list.assert_called_with('/v1/overcloud')
    ...
    def test_update(self):
        """Test updating a overcloud via PUT.
        """
    ...
    def test_delete(self):
        ...
        self.om._delete.assert_called_with('/v1/overcloud/42')
