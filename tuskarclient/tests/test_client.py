...
class ClientGetKSClientTest(tutils.TestCase):
    ...
    def test_selects_proper_values(self, mocked_ksclient):
        ...
        keys = {  # keys for KeystoneClient constructor
            'username',
            'password',
            'tenant_id',
            'tenant_name',
...
class ClientGetClientWithTokenTest(tutils.TestCase):
    ...
    def test_it_filters_kwargs(self, mocked_client):
        ...
        keys = {  # keys for Client constructor
            'insecure',
            'timeout',
            'ca_file',
            'cert_file',
...
class ClientGetTokenAndEndpointTest(tutils.TestCase):
    def setUp(self):
        ...
        self.redundant_keys = {'other_key', 'any_other_key'}
        self.missing_keys = {'os_tenant_name', 'os_service_type'}
