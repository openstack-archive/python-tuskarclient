...
@utils.arg('-d', '--description', metavar="<DESCRIPTION>", help='User-readable text describing the overcloud.')
@utils.arg('-r', '--rack-id', metavar="<RACK ID>", help='UUID of the stack, in Heat, that was created from this configuration.')
